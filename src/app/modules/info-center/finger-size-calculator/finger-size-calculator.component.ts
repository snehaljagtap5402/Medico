...
@Component({
  selector: 'app-finger-size-calculator',
  templateUrl: './finger-size-calculator.component.html',
  styleUrls: ['./finger-size-calculator.component.scss'],
})
export class FingerSizeCalculatorComponent {
